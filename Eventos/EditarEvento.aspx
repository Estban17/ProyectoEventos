<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarEvento.aspx.cs" Inherits="Eventos.EditarEvento" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="card shadow">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">Editar Evento</h3>

                    <asp:HiddenField ID="HiddenIdEvento" runat="server" />
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="DdlTipoEvento" class="form-label">Estado de Evento</label>
                    ...
                    <asp:Button ID="BtnActualizar" runat="server" Text="Actualizar Evento" CssClass="btn btn-warning w-100" OnClick="BtnActualizar_Click" />
                </div>
            </div>
        </div>
    </form>
